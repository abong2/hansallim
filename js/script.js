...
// 하단 패밀리 펼침 기능
 ...
 fixtop.addEventListener("click", function () {
  ...
  function showReview() {
    ...
    const showReview = new Swiper(".sw-review",{
      slidesPerView: 3,
      spaceBetween: 16,
      slidesPerGroup: 3,
      navigation:{
